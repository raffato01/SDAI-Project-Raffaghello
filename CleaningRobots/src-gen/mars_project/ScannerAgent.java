...
public class ScannerAgent extends Agent {
  ...
  private void __onCreate() {
    try {
    	...
    	jadescript.core.Agent.doLog(jade.util.Logger.INFO, ScannerAgent.this.getClass().getName(), ScannerAgent.this, "on create", java.lang.String.valueOf("r1 (ScannerAgent) started [Modular Behaviours]. Scanning rows 0-3."));
  ...
  public void __handleJadescriptException(final JadescriptException __exc) {
    jadescript.core.exception.ExceptionThrower __thrower = jadescript.core.exception.ExceptionThrower.__getExceptionEscalator(ScannerAgent.this);
  ...
  private void __initializeProperties() {
    ...
    {
    	ScannerAgent.this.myX = 0;
    	
    	ScannerAgent.this.myY = 0;
    	
    	ScannerAgent.this.r2X = 3;
    	
    	ScannerAgent.this.r2Y = 3;
    	
    	ScannerAgent.this.lastX = 0;
    	
    	ScannerAgent.this.lastY = 0;
    }
  }
  ...
  public ScannerAgent __theAgent() {
    return this;
  }
  ...
  public static JadescriptAgentController create(final ContainerController _container, final String _agentName) throws StaleProxyException {
    return jadescript.java.JadescriptAgentController.createRaw(_container, _agentName, mars_project.ScannerAgent.class);
  }
}
